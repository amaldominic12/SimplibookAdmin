        ...
        <ul class="nav">
                    ...
                    <a href="{{route('admin.provider.onboarding_request', ['status'=>'onboarding'])}}"
                       class="{{request()->is('admin/provider/onboarding-request')?'active-menu':''}}">
                        ...
                        <span class="link-title">{{translate('Onboarding_Request')}} <span
                                class="count">{{$pending_providers}}</span></span>
                    </a>
                </li>
            ...
            @if(access_checker('customer_management'))
                ...
                <li class="has-sub-item {{request()->is('admin/customer/list')||request()->is('admin/customer/create')?'sub-menu-opened':''}}">
                    <a href="#"
                       class="{{request()->is('admin/customer/list')||request()->is('admin/customer/create')?'active-menu':''}}">
...
{{--                </li>--}}
            ...
            @if(access_checker('system_management'))
                ...
                <li class="has-sub-item {{request()->is('admin/configuration/*') || request()->is('admin/language/translate/*')?'sub-menu-opened':''}}">
                    <a href="#" class="{{request()->is('admin/configuration/*') || request()->is('admin/language/translate/*')?'active-menu':''}}">
