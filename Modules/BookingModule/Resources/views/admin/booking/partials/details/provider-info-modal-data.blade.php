            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3"
                ...
                <form id="sort-form">
                    <div class="d-flex flex-column gap-3 title-color">
                        ...
                        <label class="d-flex gap-2 gap-sm-3 sort-by-class">
                            <input type="radio" name="sort" class="position-static" value="top-rated" {{$sort_by == 'top-rated' ? 'checked' : ''}}>
                            Top Rated
                        </label>
            ...
            <div class="d-flex gap-2 justify-content-between align-items-center mt-4 pb-3 flex-wrap">
                <div class="media gap-2">
                    <img width="60" class="rounded"
                         ...
                         onerror="this.src='{{asset('public/assets/admin-module')}}/img/placeholder.png'" alt="">
                    <div class="media-body">
                        ...
                        <div style="--bs-breadcrumb-divider: '|';">
                            <ol class="breadcrumb fs-12 mb-0">
                                ...
                                <li class="breadcrumb-item active">Bookings - {{$provider->bookings_count}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div>
                    @if($booking->provider_id == $provider->id)
                        <div class="text-success">Currently Assigned</div>
                    @else
                        <button type="button" class="btn btn-primary w-100 max-w320" onclick='updateProvider("{{$provider->id}}")'>Re Assign</button>
                    @endif
                </div>
            </div>
        @endforeach
